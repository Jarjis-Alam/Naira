...
export function DeveloperFooter() {
  ...
  const loopItems: LogoItem[] = [
    ...
    },
    {
      ...
      node: (
        <div className="flex items-center gap-2.5 px-4 py-2 rounded-full bg-surface/90 border border-border hover:border-white/40 hover:bg-white/10 transition-all duration-300 shadow-sm cursor-pointer group">
          <svg className="w-4 h-4 text-white/80 group-hover:scale-110 group-hover:text-white transition-all" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col text-left">
            <span className="text-[12px] font-semibold text-text-primary group-hover:text-white leading-tight">LinkedIn</span>
    ...
    },
    {
      ...
      node: (
        <div className="flex items-center gap-2.5 px-4 py-2 rounded-full bg-surface/90 border border-border hover:border-white/40 hover:bg-white/10 transition-all duration-300 shadow-sm cursor-pointer group">
          ...
          <div className="flex flex-col text-left">
            <span className="text-[12px] font-semibold text-text-primary group-hover:text-white leading-tight">Instagram</span>
