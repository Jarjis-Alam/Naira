      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: `radial-gradient(circle at ${glare.x}% ${glare.y}%, rgba(255,255,255,0.22) 0%, rgba(255,255,255,0.06) 30%, transparent 65%)`,
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            background: `linear-gradient(${glare.x * 3.6}deg, rgba(255,255,255,0.4), rgba(161,161,170,0.3), rgba(255,255,255,0.3), transparent 70%)`,
        ...
        >
          ...
          {linkedinUrl && (
            ...
            >
              <svg className="w-4 h-4 text-white/80 group-hover/link:text-white group-hover/link:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
